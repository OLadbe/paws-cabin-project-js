import{S as I,N as T,P as D,a as P,A as z,b as x}from"./assets/vendor-Bca1vd2s.js";(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const d of r)if(d.type==="childList")for(const u of d.addedNodes)u.tagName==="LINK"&&u.rel==="modulepreload"&&i(u)}).observe(document,{childList:!0,subtree:!0});function s(r){const d={};return r.integrity&&(d.integrity=r.integrity),r.referrerPolicy&&(d.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?d.credentials="include":r.crossOrigin==="anonymous"?d.credentials="omit":d.credentials="same-origin",d}function i(r){if(r.ep)return;r.ep=!0;const d=s(r);fetch(r.href,d)}})();new I(".about-swiper",{modules:[T,D],slidesPerView:1,spaceBetween:24,pagination:{el:".swiper-pagination",clickable:!0},navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}});const $=P.create({baseURL:"https://paw-hut.b.goit.study/api",timeout:5e3,headers:{"Content-Type":"application/json"}});document.addEventListener("DOMContentLoaded",()=>{const e=document.getElementById("categories-container"),a=document.getElementById("pets-grid"),s=document.getElementById("load-more-btn");let i="all",r=1;function d(){return window.innerWidth>=1440?9:8}async function u(){try{const t=await $.get("/categories");f(t.data)}catch(t){console.error("Помилка при завантаженні категорій:",t)}}function f(t){if(!e)return;e.innerHTML="";const c=document.createElement("button");c.classList.add("filter-btn","active"),c.setAttribute("type","button"),c.setAttribute("data-category","all"),c.textContent="Всі",e.appendChild(c),t.forEach(m=>{const l=document.createElement("button");l.classList.add("filter-btn"),l.setAttribute("type","button"),l.setAttribute("data-category",m._id),l.textContent=m.name,e.appendChild(l)})}async function S(t=!1){try{t||(r=1,a&&(a.innerHTML=""));const c={page:r,limit:d()};i!=="all"&&(c.categoryId=i);const m=await $.get("/animals",{params:c}),{animals:l,totalItems:h,page:y,limit:v}=m.data;if(l.forEach(g=>{a&&a.appendChild(M(g))}),s){const g=Math.ceil(h/v);s.disabled=y>=g}r+=1}catch(c){console.error("Помилка при завантаженні тварин:",c)}}function M(t){var A;const c=document.createElement("div");c.classList.add("pet-card");const m=t._id||t.id||"",l=t.img||t.image||t.photo||"",h=t.species||t.type||"",y=t.name||"",v=t.age||"",g=t.sex||t.gender||"",C=t.description||t.fullDescription||t.shortDescription||"",H=t.health||t.healthDescription||"Інформація про здоров’я уточнюється.",j=t.behavior||t.behaviorDescription||"Інформація про поведінку уточнюється.",_=(A=t.categories)!=null&&A.length?t.categories.map(V=>V.name).join(" &bull; "):h;return c.innerHTML=`
