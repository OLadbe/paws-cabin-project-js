...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function createAnimalCard(animal) {
    ...
    const tagsHTML = animal.categories?.length
      ? animal.categories.map(category => `<span class="pet-tag">${category.name}</span>`).join('')
      : `<span class="pet-tag">${animalSpecies}</span>`;
    ...
    card.innerHTML = `
      ...
      <div class="pet-info-block">
        ...
        <div class="pet-tags-container">${tagsHTML}</div>
