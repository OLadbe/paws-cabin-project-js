    ...
    if (!append) {
      ...
      const realPetsData = [
        { 
          ...
          description: 'Дуже активний, любить довгі прогулянки. Потребує досвідченого господаря.',
        ...
        { 
          ...
          tagsText: 'Собаки &bull; Тварини з особливими потребами &bull; Терміново шукають дім', age: '6 місяців', gender: 'Дівчинка', 
          description: 'Після операції на лапці, потребує спокійного дому та мінімального догляду. Дуже любить дітей.',
          image: 'https://unsplash.com'
        },
        { 
          id: 4, name: 'Сніжок', type: 'Кролик', category: 'rabbits', 
          tagsText: 'Кролики', age: '1 рік', gender: 'Хлопчик', 
          description: 'Привчений до лотка, любить, коли його гладять по спинці.',
          image: 'https://unsplash.com'
        },
        { 
          id: 5, name: 'Кеша', type: 'Птах', category: 'birds', 
          tagsText: 'Птахи', age: '5 років', gender: 'Хлопчик', 
          description: 'Вміє говорити «Привіт» та «Я хороший». Любить дзеркальце та увагу.',
          image: 'https://unsplash.com'
        },
        { 
          id: 6, name: 'Мурчик', type: 'Кіт', category: 'urgent', 
          tagsText: 'Коти &bull; Терміново шукають дім', age: '8 років', gender: 'Хлопчик', 
          description: 'Дуже спокійний та виважений. Ідеальний компаньйон для літньої людини. Втратив дім через переїзд господарів.',
          image: 'https://unsplash.com'
        },
        { 
          id: 7, name: 'Хома', type: 'Гризун', category: 'rodents', 
          tagsText: 'Гризуни', age: '8 місяців', gender: 'Хлопчик', 
          description: 'Дуже активний вночі. Віддається разом з великою кліткою та колесом для бігу.',
          image: 'https://unsplash.com'
        },
        { 
          id: 8, name: 'Перлинка', type: 'Кіт', category: 'special', 
          tagsText: 'Коти &bull; Тварини з особливими потребами', age: '3 роки', gender: 'Дівчинка', 
          description: 'Втратила око внаслідок травми, але це абсолютно не заважає їй бути активною, грайливою та люблячою.',
          image: 'https://unsplash.com'
        },
        { 
          id: 9, name: 'Стюарт', type: 'Гризун/Миша', category: 'urgent', 
          tagsText: 'Гризуни &bull; Тварини з особливими потребами &bull; Терміново шукають дім', age: '1,5 роки', gender: 'Хлопчик', 
          description: 'Дуже розумний, але потребує операції. Терміново потрібна допомога!',
          image: 'https://unsplash.com'
        }
      ];
